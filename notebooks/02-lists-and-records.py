...
@app.cell
def _(friehgt_charges):
    for charge_1 in friehgt_charges:
        if charge_1 < 25:
            print(charge_1)
    return
...
@app.cell
def _(freighth_charges):
    sorted(freighth_charges)
    return
